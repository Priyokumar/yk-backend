...
import prilax.yk.error.exception.*;
...
public class ErrorHandlerController extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErrorDetails> handleConflictRequestException(ConflictRequestException ex, WebRequest request) {
		ErrorDetails errorDetails = new ErrorDetails(ex.getCode(), ex.getDetail(), ex.getStatus());
